              ...
              if (feedItem.type === "requirement") {
                  ...
                  <div className="container home-container" key={index}>
                    <div className="row">
                      <div className="card home-card">
                        <img className="req-img" alt="req" src={plan} />
                        <div className="card-title  home-card-title">
                          ...
                          requires <strong>{feedItem.title}</strong>
                        </div>
                        <div className="card-text feed-card-text time feed-time">
                          <small className="text-muted">
                            {this.calcTime(feedItem.timestamp)}
                          </small>
                        </div>
                        <br />
                ...
                return (
                  <div className="container home-container" key={index}>
                    <div className="row">
                      <div className="card home-card">
                        <img className="req-img" alt="req" src={product} />
                        <div className="card-title  home-card-title">
                          <strong>
                            <div className="feed-username">
                              {feedItem.owner}
                          ...
                          is selling <strong>{feedItem.name}</strong>
                        </div>
                        <div className="card-text feed-card-text time feed-time">
                          <small className="text-muted">
                            {this.calcTime(feedItem.timestamp)}
                        ...
                        <div className="desc-prod-container">
                          <p className="card-text home-price-card-text">
                            <strong>
                              {String.fromCharCode(8377) + " " + feedItem.price}
                            </strong>
                          </p>
