              ...
              <div className="card-body">
                <form className="registerform" onSubmit={this.handleSubmit}>
                  ...
                  <div className="form-group">
                    ...
                    <input type="text" className="form-control" name="fname" aria-describedby="emailHelp" placeholder="Enter name" />
                  </div>

                  <div className="form-group">
                    <label htmlFor="PhoneNo" className="sr-only">Phone Number</label>
                    <input type="text" className="form-control" name="phoneno" aria-describedby="emailHelp" placeholder="Enter phone number" />
                  </div>
