...
class LogIn extends Component {
  ...
  render() {
    ...
    if (this.props.location.state) this.props.location.state.success = false;
    ...
    return (
      <div className="container-login100">
        {msgBlock}
        {this.state.isAlertVisible && errBlock}
        <form className="loginform" onSubmit={this.handleSubmit}>
          <h1 id="title">
            Want to sell? Want to Buy? Need Quotation?
            <br />
            Use our website
          </h1>
          <div className="form-group">
            ...
            <button type="submit" className="btn btn-primary" id="index-submit">
              Submit
            </button>
            <span className="psw">
              Don't have an account?{" "}
              <Link to="/signup" id="forgot">
                {" "}
                Register now
              </Link>
            </span>
